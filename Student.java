...
public String toString() {
	...
	return "[Rollno :"+this.rollno +",name "+ this.name+",email "+this.email+",course "+this.course+",Fee "+this.fee+""
			+ ",Amount paid "+paid+ ",Amount due "+ due+",Address "+address+",City "+city+",State "+state+",Country"+country +
			",Contactno "+contactno+"]";
...
public void takeInput() {
	try {
		...
		System.out.println("Enter Total fee paid");
		paid=input.nextInt();
